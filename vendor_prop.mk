PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.default_message0=Message_Tone.mp3 \
    ro.config.default_message1=Message_Tone.mp3 \
    ro.config.default_message=Message_Tone.mp3 \
    ...
    ro.config.notification_sound=Message_Tone.mp3 \
    ro.config.ringtone0=Evercoss_Ring.ogg \
    ro.config.ringtone1=Evercoss_Ring.ogg \
    ro.config.ringtone=Evercoss_Ring.ogg \
    ...
    ro.sf.lcd_height=96 \
    ro.sf.lcd_width=48 \
    ro.sh.nv.config=9850kl_fs098_m90_w18_fdd_b1_b3_b8_tdd_b40_ussi \
    ro.sh.project.name=sp9850ka_fs098_128x8_demo_mantis_0024015.sh \
    ...
    ww6.remove.doubleclick.gesture=true \
    ww6.smart.gesture.down=true \
    ww6.smart.gesture.left=true \
    ww6.smart.gesture.right=true \
    ww6.smart.gesture.support=true \
    ww6.smart.gesture.up=true \
